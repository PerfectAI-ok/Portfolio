...
export default function ContactSectionGreen() {
    ...
    <section className="bg-neutral-900 text-gray-100 border border-green-400 rounded-2xl">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 py-16 px-6">
        ...
        <div className="flex items-center justify-center ">
          <div className="bg-neutral-900 p-8 border border-neutral-200 rounded-2xl shadow-lg space-y-4 max-w-sm">
            <div className="flex justify-center">
              {/* <SparklesIcon className="w-10 h-10 text-green-400" /> */}
            </div>
            <h3 className="text-2xl font-bold text-center">Join Our Community</h3>
            <p className="text-gray-300 text-center">
              Follow us on social media to stay updated on the latest features and improvements.
            </p>
            <div className="flex justify-center">
